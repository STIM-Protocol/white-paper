...
## Preamble: Statement of Origin

*For the origin and motivation behind the STIM Protocol, see: ["Preamble: Statement of Origin"](STIM_Preamble_Statement_of_Origin.md) by George Steward — published as a standalone document in this repository.*
